 ...
 * Load from public: asset('js/password-checker.js') → public/js/password-checker.js (copy this file there).
 */
(function () {
    'use strict';
    ...
    function initPasswordChecklist(options) {
        ...
        var second = form.querySelector('input[name*="[plainPassword][second]"]') || form.querySelector('input[name*="plainPassword"][name*="second"]');
        if (second && submitBtn) second.addEventListener('input', onInput);
    }
