 ...
 */
final class Version20260215170145 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add face_profiles table (local face embeddings); drop users.face_token (Face++ removed).';
    }
