 ...
 */
final class Version20260221210503 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Contract offer_id and schema sync (idempotent).';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $contractColumns = array_map(
            ...
            $sm->listTableColumns('contract')
        );

        $this->addSql('ALTER TABLE category_ticket CHANGE description description VARCHAR(255) DEFAULT NULL');
        if (!in_array('offer_id', $contractColumns, true)) {
            $this->addSql('ALTER TABLE contract ADD offer_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE contract ADD CONSTRAINT FK_E98F285953C674EE FOREIGN KEY (offer_id) REFERENCES offer (id) ON DELETE SET NULL');
            $this->addSql('CREATE INDEX IDX_E98F285953C674EE ON contract (offer_id)');
        }
        ...
        $this->addSql('ALTER TABLE notification CHANGE type type VARCHAR(64) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE payload payload JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE offer CHANGE extra_revision_fee extra_revision_fee NUMERIC(10, 2) DEFAULT NULL, CHANGE start_date_available start_date_available DATE DEFAULT NULL, CHANGE delivery_date_estimated delivery_date_estimated DATE DEFAULT NULL, CHANGE rush_fee rush_fee NUMERIC(10, 2) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE match_score match_score DOUBLE PRECISION DEFAULT NULL, CHANGE proposed_budget proposed_budget NUMERIC(10, 2) DEFAULT NULL, CHANGE proposed_deadline proposed_deadline DATETIME DEFAULT NULL');
        // Skip RENAME INDEX (not supported on all MariaDB versions; index names are cosmetic)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E98F285953C674EE ON contract');
        $this->addSql('ALTER TABLE contract DROP offer_id, CHANGE currency currency VARCHAR(3) DEFAULT \'\'\'USD\'\'\' NOT NULL, CHANGE status status VARCHAR(20) DEFAULT \'\'\'DRAFT\'\'\' NOT NULL, CHANGE client_signed_at client_signed_at DATETIME DEFAULT \'NULL\', CHANGE client_signature_ip client_signature_ip VARCHAR(255) DEFAULT \'NULL\', CHANGE worker_signed_at worker_signed_at DATETIME DEFAULT \'NULL\', CHANGE worker_signature_ip worker_signature_ip VARCHAR(255) DEFAULT \'NULL\', CHANGE signed_pdf_path signed_pdf_path VARCHAR(255) DEFAULT \'NULL\', CHANGE completed_at completed_at DATETIME DEFAULT \'NULL\', CHANGE cancelled_at cancelled_at DATETIME DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE milestone CHANGE status status VARCHAR(20) DEFAULT \'\'\'PENDING\'\'\' NOT NULL, CHANGE amount amount NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE completed_at completed_at DATETIME DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE negotiation CHANGE subject subject VARCHAR(255) DEFAULT \'NULL\', CHANGE counter_price counter_price NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE extra_revision_fee extra_revision_fee NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE priority_level priority_level VARCHAR(20) DEFAULT \'NULL\', CHANGE meeting_frequency meeting_frequency VARCHAR(20) DEFAULT \'NULL\', CHANGE data_sensitivity_level data_sensitivity_level VARCHAR(20) DEFAULT \'NULL\', CHANGE late_penalty_percent late_penalty_percent NUMERIC(5, 2) DEFAULT \'NULL\', CHANGE expires_at expires_at DATETIME DEFAULT \'NULL\', CHANGE last_action_at last_action_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE notification CHANGE type type VARCHAR(50) NOT NULL, CHANGE payload payload LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE offer CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE match_score match_score DOUBLE PRECISION DEFAULT \'NULL\', CHANGE proposed_budget proposed_budget NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE proposed_deadline proposed_deadline DATETIME DEFAULT \'NULL\', CHANGE extra_revision_fee extra_revision_fee NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE start_date_available start_date_available DATE DEFAULT \'NULL\', CHANGE delivery_date_estimated delivery_date_estimated DATE DEFAULT \'NULL\', CHANGE rush_fee rush_fee NUMERIC(10, 2) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE offer RENAME INDEX idx_29d6873e19eb6921 TO IDX_offer_client');
        $this->addSql('ALTER TABLE password_reset_tokens CHANGE used_at used_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE password_reset_tokens RENAME INDEX idx_3967a216a76ed395 TO IDX_password_reset_tokens_user_id');
